<template>
    <div v-if="categories && categories.length > 0 && boxes && boxes.length > 0 && usd.kurs && usd.kurs > 0 && element && element.id && element.id > 0">
        <div class="row align-items-center mb-4">
            <div class="col-12 col-lg-6">
                <h1 class="h3 m-0">
                    <router-link v-if="element.category_id && element.category_id > 0" :to="{name: 'CategoryElements', params: { category: element.category_id }}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button @click="updateElement(element.id)" class="btn btn-primary">Сохранить</button>
            </div>
        </div>
    </div>
    <div v-else>
    ...
    export default {
        ...
        methods: {
            ...
            updateElement(id) {
                ...
                axios.put(`/api/element/${id}/update`,
                {
                    name: this.name,
