                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <select v-model="selected.stockItems" class="form-control mb-3" style="height: 200px;" multiple>
                            <option v-for="stockItem in stockItems.filter(item => item.price)" :key="'stock_item_' + stockItem.id" :value="stockItem.id">{{ stockItem.name }} - {{ middleBalancePrice(stockItem) | currency }} ₽</option>
                        </select>
                    </div>
                </div>
